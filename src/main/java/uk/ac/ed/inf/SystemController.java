...
public class SystemController {
    ...
    public static void main(String[] args) {
        ...
        HashMap<String, ArrayList<RouteNode>> routesTable = new HashMap<>();
        ...
        for (Order order : ordersByDate) {
            ...
            if (order.getOrderStatus() == OrderStatus.VALID_BUT_NOT_DELIVERED) {
                ...
                if (!routesTable.containsKey(orderRestaurant.name())) {
                    ...
                    ArrayList<RouteNode> route = routePlanner.planRoute(appletonTower, destination, noFlyZones, centralArea);
